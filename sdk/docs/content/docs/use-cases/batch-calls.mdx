...
<Tab value="/hook">
```tsx twoslash
import { useWriteHost } from "@sfpro/sdk/hook/core" // [!code focus]
import { OPERATION_TYPE } from "@sfpro/sdk/util" // [!code focus]
...
<Tab value="/abi">
```ts twoslash
import { hostAbi, hostAddress, superTokenAbi, cfaForwarderAbi } from "@sfpro/sdk/abi/core" // [!code focus]
import { OPERATION_TYPE } from "@sfpro/sdk/util" // [!code focus]
...
<Tab value="/action">
```ts twoslash
import { writeHost } from "@sfpro/sdk/action/core" // [!code focus]
import { OPERATION_TYPE } from "@sfpro/sdk/util" // [!code focus]
import { superTokenAbi, cfaForwarderAbi } from "@sfpro/sdk/abi/core"
...
- Learn about [advanced protocol features](/docs/api/core/host)
